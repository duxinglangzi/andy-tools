...
public class WXUserInfo extends BaseEntity {
	...
	private static final long serialVersionUID = -8178723122018999855L;
	...
	private JSONArray tagid_list;	//用户标签集合 2016-05-29  wq添加
	...
	public JSONArray getTagid_list() {
		return tagid_list;
	}
	public void setTagid_list(JSONArray tagid_list) {
